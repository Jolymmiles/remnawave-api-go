...
func (sc *ConfigProfileClient) ReorderConfigProfiles(ctx context.Context, request *NodePluginsBodyRequest, options ...RequestOption) (ConfigProfileReorderConfigProfilesRes, error) {
...
func (sc *ConnectionsClient) ConnectionsByUser(ctx context.Context, userid float64, options ...RequestOption) (ConnectionsConnectionsByUserRes, error) {
...
func (sc *ExternalSquadClient) CreateExternalSquad(ctx context.Context, request *NodePluginBodyRequest, options ...RequestOption) (ExternalSquadCreateExternalSquadRes, error) {
...
func (sc *ExternalSquadClient) ReorderExternalSquads(ctx context.Context, request *NodePluginsBodyRequest, options ...RequestOption) (ExternalSquadReorderExternalSquadsRes, error) {
...
func (sc *HwidUserDevicesClient) GetUserHwidDevices(ctx context.Context, userid float64, options ...RequestOption) (HwidUserDevicesGetUserHwidDevicesRes, error) {
...
func (sc *InternalSquadClient) ReorderInternalSquads(ctx context.Context, request *NodePluginsBodyRequest, options ...RequestOption) (InternalSquadReorderInternalSquadsRes, error) {
...
func (sc *MetadataClient) GetUserMetadata(ctx context.Context, userid float64, options ...RequestOption) (MetadataGetUserMetadataRes, error) {
...
func (sc *MetadataClient) UpsertNodeMetadata(ctx context.Context, request *UpsertUserMetadataBodyRequest, uuidValue string, options ...RequestOption) (MetadataUpsertNodeMetadataRes, error) {
	parsedUUID, err := uuid.Parse(uuidValue)
	if err != nil {
		return nil, err
	}
...
func (sc *MetadataClient) UpsertUserMetadata(ctx context.Context, request *UpsertUserMetadataBodyRequest, userid float64, options ...RequestOption) (MetadataUpsertUserMetadataRes, error) {
...
func (sc *NodePluginClient) CloneNodePlugin(ctx context.Context, request *CloneNodePluginBodyRequest, options ...RequestOption) (NodePluginCloneNodePluginRes, error) {
	return sc.client.NodePluginCloneNodePlugin(ctx, request, options...)
}

// CreateConfig calls NodePlugin_createConfig.
func (sc *NodePluginClient) CreateConfig(ctx context.Context, request *NodePluginBodyRequest, options ...RequestOption) (NodePluginCreateConfigRes, error) {
...
func (sc *NodePluginClient) ReorderNodePlugins(ctx context.Context, request *NodePluginsBodyRequest, options ...RequestOption) (NodePluginReorderNodePluginsRes, error) {
...
func (sc *SnippetsClient) CreateSnippet(ctx context.Context, request *SnippetBodyRequest, options ...RequestOption) (SnippetsCreateSnippetRes, error) {
	return sc.client.SnippetsCreateSnippet(ctx, request, options...)
}

// DeleteSnippetByName calls Snippets_deleteSnippetByName.
func (sc *SnippetsClient) DeleteSnippetByName(ctx context.Context, request *DeleteSnippetBody, options ...RequestOption) (SnippetsDeleteSnippetByNameRes, error) {
...
func (sc *SnippetsClient) UpdateSnippet(ctx context.Context, request *SnippetBodyRequest, options ...RequestOption) (SnippetsUpdateSnippetRes, error) {
...
func (sc *SubscriptionPageConfigClient) CloneSubscriptionPageConfig(ctx context.Context, request *CloneNodePluginBodyRequest, options ...RequestOption) (SubscriptionPageConfigCloneSubscriptionPageConfigRes, error) {
...
func (sc *SubscriptionPageConfigClient) CreateConfig(ctx context.Context, request *NodePluginBodyRequest, options ...RequestOption) (SubscriptionPageConfigCreateConfigRes, error) {
...
func (sc *SubscriptionPageConfigClient) ReorderSubscriptionPageConfigs(ctx context.Context, request *NodePluginsBodyRequest, options ...RequestOption) (SubscriptionPageConfigReorderSubscriptionPageConfigsRes, error) {
...
func (sc *SubscriptionTemplateClient) ReorderSubscriptionTemplates(ctx context.Context, request *NodePluginsBodyRequest, options ...RequestOption) (SubscriptionTemplateReorderSubscriptionTemplatesRes, error) {
...
func (sc *SubscriptionsClient) GetConnectionKeysByUserId(ctx context.Context, userid float64, options ...RequestOption) (SubscriptionsGetConnectionKeysByUserIdRes, error) {
...
func (sc *SubscriptionsClient) GetSubscriptionByUuid(ctx context.Context, userid float64, options ...RequestOption) (SubscriptionsGetSubscriptionByUuidRes, error) {
...
func (sc *UsersClient) DeleteUser(ctx context.Context, userid float64, options ...RequestOption) (UsersDeleteUserRes, error) {
...
func (sc *UsersClient) DisableUser(ctx context.Context, userid float64, options ...RequestOption) (UsersDisableUserRes, error) {
...
func (sc *UsersClient) EnableUser(ctx context.Context, userid float64, options ...RequestOption) (UsersEnableUserRes, error) {
...
func (sc *UsersClient) ExtendUserExpirationDate(ctx context.Context, request *ExtendUserBody, userid float64, options ...RequestOption) (UsersExtendUserExpirationDateRes, error) {
...
func (sc *UsersClient) GetUserAccessibleNodes(ctx context.Context, userid float64, options ...RequestOption) (UsersGetUserAccessibleNodesRes, error) {
...
func (sc *UsersClient) GetUserById(ctx context.Context, userid float64, options ...RequestOption) (UsersGetUserByIdRes, error) {
...
func (sc *UsersClient) GetUserSubscriptionRequestHistory(ctx context.Context, userid float64, options ...RequestOption) (UsersGetUserSubscriptionRequestHistoryRes, error) {
...
func (sc *UsersClient) ResetUserTraffic(ctx context.Context, userid float64, options ...RequestOption) (UsersResetUserTrafficRes, error) {
...
func (sc *UsersClient) RevokeUserSubscription(ctx context.Context, request *RevokeUserSubscriptionBody, userid float64, options ...RequestOption) (UsersRevokeUserSubscriptionRes, error) {
